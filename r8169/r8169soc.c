...
#if defined(MY_ABC_HERE) || defined(CONFIG_SYNO_R8169_NOMEM_NO_RESET)
...
#endif /* MY_ABC_HERE || CONFIG_SYNO_R8169_NOMEM_NO_RESET */
...
#if defined(CONFIG_SYNO_RTD129X)
	if (tp->led_cfg) {
...
#if defined(CONFIG_SYNO_R8169_DELAY_RETRY)
...
#else /* CONFIG_SYNO_R8169_DELAY_RETRY */
	rtl8169_init_ring(dev);
#endif /* CONFIG_SYNO_R8169_DELAY_RETRY */
...
#ifdef CONFIG_SYNO_R8169_NOMEM_NO_RESET
#else /* CONFIG_SYNO_R8169_NOMEM_NO_RESET */
#ifdef MY_ABC_HERE
		printk_syno_ratelimited(KERN_ERR"r8169_reset_task: reset with rx buffers exhausted.\n");
#endif /* MY_ABC_HERE */
		rtl_schedule_task(tp, RTL_FLAG_TASK_RESET_PENDING);
#endif /* CONFIG_SYNO_R8169_NOMEM_NO_RESET */
#ifdef CONFIG_SYNO_RTK_NETWORK_LOG_REDUCE
#ifdef CONFIG_SYNO_R8169_NOMEM_NO_RESET
