...
#define RTL8169_VERSION "2.6.3.6LK-NAPI"
...
//	struct device *device;
	...
	u32 rx_reset_count;
	u8 checkRDU;
#ifdef CONFIG_SYNO_RTK_NETWORK_LOG_REDUCE
	u64 rx_buffer_exhausted_count;
#endif /* CONFIG_SYNO_RTK_NETWORK_LOG_REDUCE */
	#endif /* CONFIG_RTL_RX_NO_COPY */
...
static const char rtl8169_gstrings[][ETH_GSTRING_LEN] = {
	...
	"tx_aborted",
	"tx_underrun",
#if defined(CONFIG_SYNO_RTK_NETWORK_LOG_REDUCE) && defined(CONFIG_RTL_RX_NO_COPY)
	"rx_buffer_exhausted",
#endif /* CONFIG_SYNO_RTK_NETWORK_LOG_REDUCE && CONFIG_RTL_RX_NO_COPY */
};
...
static void rtl_hw_start_8168g_1(struct rtl8169_private *tp)
{
	...
	#if !defined(RTL_ADJUST_FIFO_THRESHOLD) || defined(CONFIG_SYNO_RTD1619_R8169_HIGH_LATENCY_FIX)
	rtl_eri_write(tp, 0xc8, ERIAR_MASK_0101, 0x080002, ERIAR_EXGMAC);
	rtl_eri_write(tp, 0xcc, ERIAR_MASK_0001, 0x38, ERIAR_EXGMAC);
	rtl_eri_write(tp, 0xd0, ERIAR_MASK_0001, 0x48, ERIAR_EXGMAC);
	#endif /* !RTL_ADJUST_FIFO_THRESHOLD || CONFIG_SYNO_RTD1619_R8169_HIGH_LATENCY_FIX */
	rtl_eri_write(tp, 0xe8, ERIAR_MASK_1111, 0x00100006, ERIAR_EXGMAC);
...
static void rtl_hw_start_8168(struct net_device *dev)
{
...
#if defined(CONFIG_SYNO_RTD1619_R8169_HIGH_LATENCY_FIX)
#else /* CONFIG_SYNO_RTD1619_R8169_HIGH_LATENCY_FIX */
	#if defined(CONFIG_ARCH_RTD16xx)
	...
	#endif /* CONFIG_ARCH_RTD16xx */
#endif /* CONFIG_SYNO_RTD1619_R8169_HIGH_LATENCY_FIX */
...
#else /* CONFIG_SYNO_RTK_NETWORK_LOG_REDUCE */
...
static int rtl8169_poll(struct napi_struct *napi, int budget)
{
	...
	int work_done = 0;
	u16 status;
	#if defined(RTL_ADJUST_FIFO_THRESHOLD) && defined(CONFIG_RTL_RX_NO_COPY)
	u32 old_dirty_rx;
	#endif /* RTL_ADJUST_FIFO_THRESHOLD & CONFIG_RTL_RX_NO_COPY */
...
//#define ETN_DBUS_CLK    0x98007fc0
	...
	do{
		...
		entry = proc_create_data("eth_phy", S_IFREG | S_IRUGO,
				   dir_dev, &eth_phy_proc_fops, NULL);
		if (!entry) {
			printk(KERN_INFO "procfs:create /proc/net/eth0/r8169/eth_phy failed\n");
			break;
		}
