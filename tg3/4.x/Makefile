...
# Copyright (C) 2007-2016 Broadcom.  All Rights Reserved.
...
BCMCFGDIR=/home/dev/tmp/dsm7.1/usr/local/x86_64-pc-linux-gnu/x86_64-pc-linux-gnu/sys-root/usr/lib/modules/DSM-7.1/build
ifeq ($(BCMCFGDIR),)
...
BCMSRCDIR=/home/dev/tmp/dsm7.1/linux-4.4.x
ifeq ($(BCMSRCDIR),)
...
CC = /home/dev/tmp/dsm7.1/x86_64-pc-linux-gnu/bin/x86_64-pc-linux-gnu-gcc
